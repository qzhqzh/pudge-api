...
LOGGING = {
    ...
    'handlers': {
        ...
        'sql': {
            ...
            # 日志输出文件
            'filename': os.path.join(BASE_DIR, 'storage', 'log', 'sql.log'),
            # 文件大小
        ...
        'debug': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(BASE_DIR, 'storage', 'log', 'debug.log'),
        ...
        'access_log': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(BASE_DIR, 'storage', 'log', 'access.log'),
            'maxBytes': 1024 * 1024 * 20,
            'backupCount': 30,
            'formatter': 'common'
        }
